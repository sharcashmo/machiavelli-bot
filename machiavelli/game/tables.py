...
class GameTables:
    ...
    expenses: Final[dict[str, ExpenseInfo]] = {
        ...
        "E": {"text": "Ordenar asesinato", "target_type": "power", "cost": 12},
        "F": {"text": "Contra-soborno", "target_type": "unit", "cost": 3},
        "G": {
            "text": "Desbandar guarnición autónoma",
            "target_type": "unit",
            "cost": 6,
        },
        "H": {"text": "Comprar guarnición autónoma", "target_type": "unit", "cost": 9},
        "I": {
            "text": "Convertir guarnición en autónoma",
            "target_type": "unit",
            "cost": 9,
        },
        "J": {"text": "Desbandar unidad", "target_type": "unit", "cost": 12},
    ...
    military_orders: Final[dict[str, OrderInfo]] = {
        ...
        "L": {"text": "Levantar asedio", "target_type": None},
        "S": {"text": "Apoyar Provincia o Mar", "target_type": "location_ext"},
        "T": {"text": "Transportar Ejército", "target_type": "army_ext"},
